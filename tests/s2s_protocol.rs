...
fn test_sjoin_roundtrip() {
    ...
    assert_eq!(serialized, "SJOIN 1234567890 #test +nt key :@001AAAAAA 001AAAAAB +001AAAAAC");
    ...
    let parsed = Command::new("SJOIN", vec!["1234567890", "#test", "+nt", "key", "@001AAAAAA 001AAAAAB +001AAAAAC"]).unwrap();
